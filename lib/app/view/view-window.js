    ...
    return function (app) {
        ...
        var configs = {
            ...
            defaultWndOptions: {
                ...
                el: null,
                center: true,
                template: '<div class="fn-wnd fn-wnd-placeholder"><span class="ui-dialog-loading fn-s-loading">' + i18n.loadingText + '</span></div>',
                destroyedOnClose: true,
                children: null,
                // 窗口配置
                options: {
                    title: i18n.defaultDialogTitle
                }
            }
        };
        ...
        var methods = {
            ...
            window: function (options, isShow) {
                ...
                var defaultOptions = this._windowProvider().options(this.defaultWndOptions);
