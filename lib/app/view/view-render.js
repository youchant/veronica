define(function () {
    ...
    return function (app) {
        ...
        var methods = {
            ...
            _templateEngineProvider: function () {
                var app = this.options.sandbox.app;
                return app.templateEngineProvider.get(this.templateEngine);
            },
            _compileTemplate: function (templateText) {
                return this._templateEngineProvider().compile(templateText, this);
            },
            _executeTemplate: function (compiled) {
                var options = this._templateEngineProvider().options(this);
